    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="border: 3px ridge white">
                <h1 style="margin: auto;font-size:24px;margin-top:10px">Editar Registro De Responsables</h1>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/')}}/responsable/{{$responsable['Id_responsable']}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Nom_responsable" oninput="capitalizeFirstLetter(this)" type="text" min="0" value="{{ $responsable['Nom_responsable']}}" class="form-control @error('Nom_responsable') is-invalid @enderror" name="Nom_responsable" value="{{ old('Nom_responsable') }}" required autocomplete="Nom_responsable">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Correo_responsable"  oninput="capitalizeFirstLetter(this)" type="email" min="0" value="{{ $responsable['Correo_responsable']}}" class="form-control @error('Correo_responsable') is-invalid @enderror" name="Correo_responsable" value="{{ old('Correo_responsable') }}" required autocomplete="Correo_responsable">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Tel_responsable" type="number" min="0"  value="{{ $responsable['Tel_responsable']}}" class="form-control @error('Tel_responsable') is-invalid @enderror" name="Tel_responsable" value="{{ old('Tel_responsable') }}" required autocomplete="Tel_responsable">
