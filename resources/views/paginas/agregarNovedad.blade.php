                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/')}}/novedad/">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Codigo_novedad" type="number" min="0" value="" class="form-control @error('Codigo_novedad') is-invalid @enderror" name="Codigo_novedad" value="{{ old('Codigo_novedad') }}" required autocomplete="Codigo_novedad">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Nom_novedad" type="text" value="" class="form-control @error('Nom_novedad') is-invalid @enderror" name="Nom_novedad" value="{{ old('Nom_novedad') }}" required autocomplete="Nom_novedad">
