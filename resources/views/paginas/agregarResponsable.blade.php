    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="border: 3px ridge white">
                <h1 style="margin: auto;font-size:24px;margin-top:10px">Agregar Registro De Responsables</h1>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/')}}/responsable/">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Nom_responsable" oninput="capitalizeFirstLetter(this)" type="text" min="0" value="" placeholder="Ingrese El Nombre Del Responsable" class="form-control @error('Nom_responsable') is-invalid @enderror" name="Nom_responsable" value="{{ old('Nom_responsable') }}" required autocomplete="Nom_responsable">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Correo_responsable" oninput="capitalizeFirstLetter(this)" type="email" min="0" value="" placeholder="Ingrese El Correo Del Responsable" class="form-control @error('Correo_responsable') is-invalid @enderror" name="Correo_responsable" value="{{ old('Correo_responsable') }}" required autocomplete="Correo_responsable">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button style="margin-left: 80px;" type="submit" class="btn btn-success" v-on:click="GuardarregistroResponsable()">
