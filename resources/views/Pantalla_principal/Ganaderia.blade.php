...
<body>
    ...
    <section id="pantalla-dividida">
        <div class="izquierda">
            ...
            <br>
            <p>Un área grande el cual su función es la produccion de leche , produccion de terneros y venta de ganado como tal , comercializándola a nivel regional para su mantenimiento.</p>
        </div>
